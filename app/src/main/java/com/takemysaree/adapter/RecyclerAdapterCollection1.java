...
public class RecyclerAdapterCollection1 extends RecyclerView.Adapter<RecyclerAdapterCollection1.ViewHolder> {
    ...
    public RecyclerAdapterCollection1(Context mContext ) {
