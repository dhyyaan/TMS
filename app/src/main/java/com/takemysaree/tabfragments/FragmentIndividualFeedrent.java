...
import com.takemysaree.adapter.HomeGridAdapterrent;
...
public class FragmentIndividualFeedrent extends Fragment {
    private GridView rv;
    private LatoRegularTextview nodata;
    HomeGridAdapter adapter;

    public FragmentIndividualFeedrent() {

    }

    public static FragmentIndividualFeedrent newInstance() {


        return new FragmentIndividualFeedrent();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.rent_listing, container, false);
        ...
        category.addQueue();
        // tvtitle.setText("ASSINGED SCHEDULE");
    ...
    public class Category {
        ...
        public Category() {
            ...
            sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL + BaseUrl.product_list +
                    "&page=1" + "&pro_type=1", new Response.Listener<String>() {
                @Override
