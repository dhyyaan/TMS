...
public class FragmentIndividualFeedbuy extends Fragment {
    private GridView rv;
    private LatoRegularTextview nodata;
    HomeGridAdapter adapter;
    public FragmentIndividualFeedbuy(){

    }
    public static FragmentIndividualFeedbuy newInstance() {


        return new FragmentIndividualFeedbuy();
    }
    @Nullable
    @Override
    ...
    public class Category {
        ...
        public Category() {
            ...
            sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL + BaseUrl.product_list +
                    "&page=1"+"&pro_type=2", new Response.Listener<String>() {
                @Override
