...
public class FragmentVendorsFeed extends Fragment {
    private GridView rv;
    HomeGridAdapter adapter;
    private LatoRegularTextview nodata;

    public FragmentVendorsFeed(){

    }
    public static FragmentVendorsFeed newInstance() {


        return new FragmentVendorsFeed();
    }
    @Nullable
    @Override
    ...
    public class Category {
        ...
        public Category() {
            ...
            sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL + BaseUrl.product_list + "&page=1"+"&is_vendor=1", new Response.Listener<String>() {
                @Override
