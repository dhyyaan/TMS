...
public class FragmentIndividualFeed extends Fragment {
    private LatoRegularTextview nodata;

    public FragmentIndividualFeed() {

    }

    public static FragmentIndividualFeed newInstance() {


        return new FragmentIndividualFeed();
    }
    ...
    public class Category {
        ...
        public Category() {
            ...
            sr = new StringRequest(Request.Method.GET,
                    BaseUrl.BASE_URL + BaseUrl.product_list + "&page=1", new Response.Listener<String>() {
                @Override
