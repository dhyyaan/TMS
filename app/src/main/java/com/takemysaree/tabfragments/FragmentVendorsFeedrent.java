...
public class FragmentVendorsFeedrent extends Fragment {
    private GridView rv;
    private LatoRegularTextview nodata;
    HomeGridAdapter adapter;
    public   FragmentVendorsFeedrent(){

    }
    public static FragmentVendorsFeedrent newInstance() {


        return new FragmentVendorsFeedrent();
    }
    @Nullable
    @Override
    ...
    public class Category {
        ...
        public Category() {
            ...
            sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL + BaseUrl.product_list +
                    "&page=1"+"&is_vendor=1"+"&pro_type=1", new Response.Listener<String>() {
                @Override
