...
public class RoundCornersTransform4 implements Transformation {
     ...
     */
    public RoundCornersTransform4(final int radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
     ...
     */
    public RoundCornersTransform4(final int radius, final int margin, boolean topCornersOnly,
