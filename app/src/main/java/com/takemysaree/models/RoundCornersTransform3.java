...
public class RoundCornersTransform3 implements Transformation {
     ...
     */
    public RoundCornersTransform3(final int radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
     ...
     */
    public RoundCornersTransform3(final int radius, final int margin, boolean topCornersOnly,
    ...
    public Bitmap transform(final Bitmap source) {
        ...
        if (topCorners && bottomCorners) {
            ...
            canvas.drawPath(RoundedRect(margin, margin, source.getWidth() - margin,
                    source.getHeight() - margin, radius, radius, true, true,
                    false, false), paint);
        }
