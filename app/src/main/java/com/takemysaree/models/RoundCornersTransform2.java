...
public class RoundCornersTransform2 implements Transformation {
     ...
     */
    public RoundCornersTransform2(final int radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
     ...
     */
    public RoundCornersTransform2(final int radius, final int margin, boolean topCornersOnly,
    ...
    public Bitmap transform(final Bitmap source) {
        ...
        if (topCorners && bottomCorners) {
            ...
            canvas.drawPath(RoundedRect(margin, margin, source.getWidth() - margin,
                    source.getHeight() - margin, radius, radius, false, false,
